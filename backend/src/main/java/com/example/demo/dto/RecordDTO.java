...
public class RecordDTO implements Serializable {
	...
	private Plataforma gamePlatform;
	...
	public RecordDTO(Record entity) {
		...
		genreName=entity.getGame().getGenero().getName();
	}
	...
	public Plataforma getGamePlatform() {
		return gamePlatform;
	}

	public void setGamePlatform(Plataforma gamePlatform) {
